...
| **Medida de la Respuesta** | Vaga (*"rápido"*) | **Rendimiento:** Latencia $\text{p95} \le 200\text{ ms}$; Throughput $\ge 1.000\text{ TPS}$.<br>**Disponibilidad:** Uptime $\ge 99.99\%$; RTO $\le 30\text{ s}$; RPO $= 0$.<br>**Seguridad:** $100\%$ de ataques mitigados; registro de auditoría en $\le 50\text{ ms}$.<br>**Modificabilidad:** Implementación y despliegue en $\le 16\text{ horas-persona}$ sin alterar interfaces públicas. |
